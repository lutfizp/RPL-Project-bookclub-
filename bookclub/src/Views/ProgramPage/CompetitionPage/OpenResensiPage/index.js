      ...
      <div className="max-h-screen carousel carousel-vertical max-w-screen flex flex-col pt-16">
          ...
          >
            <div className="hero-content flex-col lg:flex-row" style={{ }}>
              ...
              <p className="sm:max-w-sm sm:max-h-sm py-3 text-justify animate-fade-up"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
                Dalam rangka memperingati World Book Day 2022, Perpustakaan Kantor Perwakilan (KPW) Bank Indonesia Riau mengadakan acara Lomba Resensi Buku dan Speech Contest. 
                Acara ini bertujuan untuk meningkatkan minat baca masyarakat serta menumbuhkan kemampuan berpikir kritis dan keterampilan berbicara di depan umum.
        ...
        >
          ...
          <p className="sm:max-h-sm px-10 text-justify"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
            Lomba resensi buku ini terbuka untuk berbagai kalangan, mulai dari pelajar, mahasiswa, hingga masyarakat umum. Peserta diminta untuk 
            membuat resensi buku dari buku yang mereka pilih. Resensi harus mencakup ringkasan isi buku, analisis kekuatan dan kelemahan buku, 
            serta pendapat pribadi peserta mengenai buku tersebut.
          </p>
          <p className="sm:max-h-sm px-10 text-justify"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
            Penilaian dilakukan oleh dewan juri yang terdiri dari akademisi, praktisi, dan pegiat literasi. Kriteria penilaian untuk lomba 
            resensi buku mencakup kedalaman analisis, kreativitas, dan kejelasan penulisan. Sementara untuk speech contest, penilaian 
            meliputi keterampilan berbicara, kejelasan penyampaian, dan kekuatan argumen.
            </p>
          <p className="sm:max-h-sm px-10 text-justify"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
            Para pemenang akan mendapatkan hadiah menarik berupa trofi, sertifikat, dan sejumlah uang tunai. Selain itu, karya terbaik juga akan 
            dipublikasikan di berbagai media sebagai bentuk apresiasi dan motivasi bagi peserta lainnya.
              </p>
              </div>
