            ...
            <div className="hero-content flex-col lg:flex-row" style={{ marginTop: '-100px' }}>
              <div className="md:pr-20 animate-fade-left" style={{ flex: 30 }}>
                ...
                <div className="w-[30%] sm:w-[30%] ml-75 mr-100">
                  <div className="card677777 bg-gradient-to-b from-[#C8AE7D] from-95% to-[#C8AE7D]  shadow-xl animate-fade-up" style={{ width: '245px', height: '355px', borderRadius: '29px', marginLeft: '-350px', marginTop: '7dfffffffffffgvvvvvvvvvvvv0px'}}>
                    <figure className="px-4 pt-5">
                ...
                <div className="w-[30%] sm:w-[30%] ml-75 mr-100">
                  <div className="card677777 bg-gradient-to-b from-[#C8AE7D] from-95% to-[#C8AE7D]  shadow-xl animate-fade-up" style={{ width: '245px', height: '355px', borderRadius: '29px', marginLeft: '-30px', marginTop: '20'}}>
                    <figure className="px-4 pt-5">
                      <img src="/images/update2.jpg" 
                      alt="Shoes" 
                      style={{ width: '245px', height: '194px', borderRadius: '24px' }}
