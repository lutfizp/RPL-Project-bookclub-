      ...
      <div className="max-h-screen carousel carousel-vertical max-w-screen flex flex-col pt-16">
          ...
          >
            <div className="hero-content flex-col lg:flex-row" style={{ }}>
              ...
              <p className="sm:max-w-sm sm:max-h-sm py-3 text-justify animate-fade-up"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
                Flores Writers Festival yang ketiga di Maumere pada 8-10 November 2023 mengusung tema "Sadang Bui," yang bermakna memori dan metafora. Sebagai memori, 
                Sadang Bui adalah nama pelabuhan di pesisir utara Maumere yang sekarang disebut Pelabuhan Lorens Say. Sebagai metafora, tema ini menggali isu-isu krusial 
                lokal Flores seperti perantauan, perdagangan manusia, dan kapitalisme yang menginjak budaya bahari masyarakat setempat.
              </p>
              </div>  
            </div>
          </motion.div>
        ...
        >
          ...
          <p className="sm:max-h-sm px-10 text-justify"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
            Festival dibuka dengan Seminar Budaya bertema "Jejak Keterhubungan serta Interaksi Translokalitas di Flores, Indonesia, dan Dunia," 
            yang diikuti oleh berbagai sesi bincang tematik. Seminar ini menghadirkan para pemikir dan aktivis seperti Dr. Otto Gusti Madung, 
            Valentino Luis, Anitha Silvia, dan Fernando Ximenes. Sesi-sesi lainnya mengangkat topik seperti peran kecerdasan buatan dalam proses 
            kreatif, fiksi dan kebebasan kreatif, serta spektrum penciptaan karya kreatif.
          </p>
          <p className="sm:max-h-sm px-10 text-justify"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
            Hari kedua festival di Universitas Nusa Nipa Maumere diisi dengan bincang tematik yang membahas berbagai topik, seperti pengarsipan 
            kisah masa lalu dan proses kreatif dalam penulisan fiksi. Pada malam hari, peserta festival menonton dan berdiskusi tentang film 
            dokumenter dalam Maumere Cinema. Pembicara dari berbagai latar belakang berbagi pandangan mereka, menciptakan suasana diskusi 
            yang kaya dan beragam.
            </p>
          <p className="sm:max-h-sm px-10 text-justify"style={{ fontFamily: 'Rosarivo', color:"#484848", fontStyle: 'italic', fontSize: '20px'}}>
            Flores Writers Festival memaknai Sadang Bui sebagai penanda kosmopolitanisme dan keterhubungan antar lokalitas di Flores. Tema ini 
            menegaskan kesamaan ras, karakter, fisik, ide, kultur, sejarah, bahasa, dan agama di Flores, menciptakan solidaritas yang kuat. 
            Festival ini juga menggarisbawahi pentingnya ingatan kolektif dalam menghadapi laju pembangunan yang mengancam ruang-ruang privat 
            masyarakat. Melalui tema dan diskusi yang diangkat, FWF berusaha menjaga ingatan kolektif dan tradisi dari ancaman perubahan.
              </p>
              <a
                  href="https://www.bacapetra.co/memori-dan-metafora-di-flores-writers-festival-3-sadang-bui-di-maumere/"
